...
The current-tree publication scan does not sanitize prior commits. Legacy history is a known hardening gap tracked in [GitHub issue #4](https://github.com/GuillaumeRacine/inneros-docs/issues/4) and must not be described as private or clean until that work is complete.
