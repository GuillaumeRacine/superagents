...
> Snapshot: **September 8, 2026 at 7:17 p.m.**. Generated from the authenticated GitHub account inventory and repository trees.
...
| Scan failures | 0 |
| Truncated trees | 0 |
| Declaration files selected | 590 |
| Declaration files inspected | 590 |
...
| Documentation files discovered | 9,788 |
...
| [GuillaumeRacine/inneros-docs](https://github.com/GuillaumeRacine/inneros-docs) | public | active | tree-scanned | yes | yes | present | 4 |
