...
export const columns = {
  ...
  reportedTotals: ["id", "date", "currency", "net", "source", "note"],
  sources: ["id", "name", "url", "asOf", "checkedAt", "status", "note"],
};
...
const enums = {
  ...
  status: ["active", "dead", "exited", "closed", "unknown"],
...
const required = {
  ...
  sources: ["id", "name", "checkedAt", "status"],
  reportedTotals: ["id", "date", "currency"],
};
...
export function validateFinance(raw) {
  ...
  for (const [kind, fields] of Object.entries(columns)) {
    const sourceRows =
      ["statements", "sources", "reportedTotals"].includes(kind) &&
      raw[kind] === undefined
        ? []
        : raw[kind];
    ...
    data[kind] = sourceRows.map((input, index) => {
      try {
        ...
        ids.add(key);
        for (const key of ["date", "due", "asOf", "checkedAt"])
            ...
            : kind === "assets"
              ...
              : kind === "transactions"
                ...
                : kind === "tasks"
                  ...
                  : kind === "sources"
                    ? {
                        status: ["current", "partial", "stale", "needs-review"],
                      }
                    : {};
